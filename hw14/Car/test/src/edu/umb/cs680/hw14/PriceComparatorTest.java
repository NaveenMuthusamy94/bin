...
class PriceComparatorTest {
	...
	private static void setUpOfCars() {
		...
		cars.add(c2);
		Car c3 = new Car("X7", "Audi", 2014, 3000, 7000);
		cars.add(c3);
		Car c4 = new Car("A8", "Audi", 2014, 1000, 5000);
		cars.add(c4);
	...
	public void testForFirstCar() {
		String[] expected = {"A8", "Audi", "2014", "1000.0", "5000"};
	...
	public void testForSecondCar() {
		String[] expected = {"X7", "Audi", "2014", "3000.0", "7000"};
	...
	public void testForThirdCar() {
		String[] expected = {"Zen", "Maruthi", "1994", "19000.0", "4000"};
